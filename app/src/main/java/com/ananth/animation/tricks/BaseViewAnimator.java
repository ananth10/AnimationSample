...
public abstract class BaseViewAnimator {
    ...
    public BaseViewAnimator addAnimatorListener(android.animation.Animator.AnimatorListener l) {
    ...
    public void removeAnimatorListener(android.animation.Animator.AnimatorListener l) {
